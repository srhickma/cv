...
\begin{cventries}
  ...
  \cventry {Secure nonce file transfers in the cloud} {dead-drop} {Go} {May 2019
    - present} {
    \begin{cvitems}
  ...
  \cventry {Fast and Automatic Formatter of Context-Free Languages} {padd}
  ...
  \cventry {Text-based process manager for boosting productivity} {lens} {Java}
  {2017} {
    \begin{cvitems}
  ...
  \cventry {Database for sharing study resources} {www.photesto.space} {PHP,
