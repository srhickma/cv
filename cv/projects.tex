...
\begin{cventries}
  ...
  \cventry {Secure nonce file transfers in the cloud} {\href{https://github.com/srhickma/dead-drop}{dead-drop}} {Go} {May 2019
    - present} {
    \begin{cvitems}
  ...
  \cventry {Fast and Automatic Formatter of Context-Free Languages} {\href{https://github.com/srhickma/padd}{padd}}
  ...
  \cventry {2D procedural side-scroller using Unity Game Engine}
  ...
  \cventry {Text-based process manager for boosting productivity} {\href{https://github.com/srhickma/lens}{lens}} {Java}
  {2017} {
    \begin{cvitems}
  ...
  \cventry {Database for sharing study resources} {\href{www.photesto.space}{www.photesto.space}} {PHP,
